...
PRIVATE_CONFIG=kim1.conf geth --datadir qdata $GLOBAL_ARGS --verbosity 6 --raftport 50400 --rpcport 22000 --port 21000 --unlock 8 --password passwords 2>qdata/logs/kim1.log &
